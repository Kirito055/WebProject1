                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-lg-7 col-md-8">
                            <div class="hero__caption">
                                ...
                                <h1 data-animation="fadeInLeft" data-delay=".4s">Become part of your country's digital
                                    history</h1>
                                <!-- Hero-btn -->
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-caption mb-50">
                        ...
                        <div class="section-tittle mb-35">
                            ...
                            <h2>For the entrant</h2>
                        </div>
                        <p>Astana IT University provides 1,100 targeted grants for 2020. Grants are awarded on a
                            competitive basis in accordance with the points of the UNT certificates.</p>
                        <ul>
            ...
            <div class="row justify-content-sm-center">
                <div class="cl-xl-7 col-lg-8 col-md-10">
                    ...
                    <div class="section-tittle text-center mb-70">
                        ...
                        <h2>Undergraduate educational programs</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cat mb-50">
                        ...
                        <div class="cat-cap">
                            ...
                            <p>Sorem hpsum folor sixdsft amhtget, consectetur adipiscing eliht, sed do eiusmod tempor
                                incidi.</p>
